...
class CurrentWeatherContainer(flet.Container):
    def __init__(self, *args, **kwargs):
        ...
        self.weather_icon = flet.Image(src=f'welcome_image.png', width=340, height=340, top=-115, left=-105, visible=False)
        self.temperature = flet.Text(value='', size=74, color='#ffffff', margin=flet.Margin.only(left=84))
        self.weather_description = flet.Text(value='', size=24, color='#ffffff')
